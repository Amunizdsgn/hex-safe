    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-xl p-6 animate-slide-up">
        ...
        <div className="flex items-center justify-between gap-4">
          {/* Company */}
          <div className="flex-1 bg-primary/5 border border-primary/20 rounded-xl p-5">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">Transferências</p>
            <p className="text-sm font-medium text-foreground">{formatCurrency(totalTransfers)}</p>
          </div>

          {/* Personal */}
          <div className="flex-1 bg-accent/5 border border-accent/20 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
