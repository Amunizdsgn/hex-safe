...
import { CheckCircle2, Clock, AlertTriangle, Filter, PlusCircle } from 'lucide-react';
                ...
                <Sheet>
                    ...
                    <SheetContent className="w-full sm:max-w-md border-l border-border/50 bg-background/80 backdrop-blur-xl">
                        <SheetHeader className="mb-6">
                            <SheetTitle className="text-2xl font-bold">Nova Conta</SheetTitle>
                            <SheetDescription>Cadastre uma nova conta bancária ou categoria.</SheetDescription>
                        </SheetHeader>
                        <AccountForm />
                    </SheetContent>
                </Sheet>
